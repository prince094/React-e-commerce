        ...
        <>
          <div className="relative w-full">
            <Listbox.Button
              ...
              className={`
              relative cursor-default rounded border
               border-[#E2E9F2] bg-white  text-left 
                text-[#191717] focus:outline-none sm:text-sm sm:leading-6
                ${subselect ? 'pl-[14px] pr-8' : 'pl-5 pr-10 '}
                `}
            >
              <p className="block flex flex-col truncate text-sm sm:text-base">
                {subselect && (
                  <span className="text-sm text-[#566879]">
                    {subselectText}
                  </span>
                )}
