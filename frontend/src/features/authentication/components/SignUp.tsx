  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        ...
        <TextInfo text="Fill out so we know how to contact you." />
      </div>
      <div className="flex items-center">
        <div className="mr-10 flex-shrink-0 flex-grow-0 basis-full sm:basis-1/2">
      ...
      <div className="flex items-center">
        ...
        <TextInfo text=" Required to clarify the details of the order." />
      </div>
      <div className="flex items-center">
        <div className="mr-10 flex-shrink-0 flex-grow-0 basis-full sm:basis-1/2">
          <Input
        ...
        <TextInfo text=" The password must be at least 6 characters long." />
      </div>
      <div className="flex items-center">
        <div className="mr-10 flex-shrink-0 flex-grow-0 basis-full sm:basis-1/2">
          <Input
      ...
      <Button type="success" className="sm:w-1/2">
        Sign In
      </Button>
    </Form>
  );
